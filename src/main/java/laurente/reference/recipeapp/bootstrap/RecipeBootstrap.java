package laurente.reference.recipeapp.bootstrap;

import laurente.reference.recipeapp.domain.*;
import laurente.reference.recipeapp.repositories.CategoryRepository;
import laurente.reference.recipeapp.repositories.RecipeRepository;
